...
omega_T = 0 ; %=constant; for constant maneuvering target;
...
[t,y] = ode45(@PP_kinematics,tspan,[R0 theta0 Vtheta0 Vr0 alphaP0 alphaT0 xt0 yt0 xp0 yp0],options);
R = y(:,1);
theta = y(:,2);
Vtheta = y(:,3);
Vr = y(:,4);
